...
<span style="display:inline-block; margin-left: 2em;"></span> **Barbereau, T.**, & Bodó, B. (2023). "Beyond Financial Regulation of Crypto-asset Wallet Software: In Search of Secondary Liability".[^1] _Computer Law & Security Review_, 49. doi: [10.1016/j.clsr.2023.105829](https://doi.org/10.1016/j.clsr.2023.105829).
...
+ Delgado Fernandez, J., **Barbereau, T.**, & Papageorgiou, O. (2024). "Agent-based Model of Initial Token Allocations: Simulating Distributions post Fair Launch". ACM Transactions of Management Information Systems. doi: [10.1145/3649318](https://doi.org/10.1145/3649318).
...
+ Sedlmeir, J., **Barbereau, T.**, Roth, T., Weigl, L., & Huber, J. (2022). "Transition Pathways towards Design Principles of Self-sovereign Identity". _Proceedings of the 43<sup>rd</sup> International Conference on Information_. URL: [aisel.aisnet.org/icis2022/is\_implement/is\_implement/4](https://aisel.aisnet.org/icis2022/is_implement/is_implement/4).
